...
export class DynamoFollowsDAO extends ParentDAO implements FollowsDAO {
    ...
    async removeFollower(followeeAlias: string, followerAlias: string): Promise<boolean> {
        ...
        return this.doOperation(command, () => {return true;});
    ...
    async getPageOfFollowees(followerHandle: string, pageSize: number, lastFolloweeHandle: string | undefined): Promise<any> {
        ...
        return this.doOperation(command, (result: any) => {return result.Items});
    }
